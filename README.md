...
- Sero motorlar olarak MG996R yüksek torklu servo motor kullanıldı.
- UART üzerinden komut satırı arayüzü tasarlandı bu sayede kullanıcının servo açılarını kontrol edebilmesi sağlandı.
- Timer/PWM konfigürasyonu ve komut doğrulama protokolü (ACK) uçtan uca kodlandı.
